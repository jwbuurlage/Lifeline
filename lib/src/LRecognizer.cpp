...
namespace Lifeline
{
  Recognizer::Recognizer(int _imageSize = 65)
  {
  ...
  void Recognizer::loadDataFromFile()
  {
    
  }

  void Recognizer::setPointData(std::vector<Touch> data)
  {

  }

  void Recognizer::normalizeData()
  {
